...
function detectCountryByPhone(phone) {
  ...
  const prefixMap = {
    ...
    '56': 151, '55': 73, '54': 39, '52': 54, '49': 43, '48': 15, '44': 16,
    '43': 50, '39': 86, '34': 56, '33': 78, '27': 31, '20': 21, '7': 2, '1': 36,
  };
...
function formatPhoneNumber(phone) {
  ...
  const clean = phone.replace(/[\s\-()]+/g, '');
  const prefixMap = { '996': 3, '380': 3, '254': 3, '234': 3, '852': 3, '351': 3, '90': 2, '91': 2, '84': 2, '81': 2, '66': 2, '65': 2, '63': 2, '62': 2, '60': 2, '57': 2, '56': 2, '55': 2, '54': 2, '52': 2, '49': 2, '48': 2, '44': 2, '43': 2, '39': 2, '34': 2, '33': 2, '27': 2, '20': 2, '7': 1, '1': 1 };
  const keys = Object.keys(prefixMap).sort((a, b) => b.length - a.length);
  for (const prefix of keys) {
